...
def arguments():
    ...
    parser.add_argument('-o', '--table-name', default = 'primer_combinations.sts', help='Name of primer table output')
    
    parser.add_argument('primers', 
                        help='Fasta file with expanded degenerate primers')
    return parser.parse_args()

# Make sure that combinations with the same primers are not duplicated
